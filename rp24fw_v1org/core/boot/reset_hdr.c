...
/* 戻り値 | なし                                        */
/********************************************************/
static void init_pll(u4 pll, UINT refdiv, UINT vco_freq, UINT post_div1, UINT post_div2)
{
...
/* 戻り値 | なし                                        */
/********************************************************/
static void clock_config(UINT clock_kind, u4 auxsrc, u4 src_freq, u4 freq)
{
    u4  clock;
    u4  div;
